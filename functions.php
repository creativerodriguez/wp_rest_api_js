...
function primer_resources() {
	wp_enqueue_style('custom_css', get_template_directory_uri() . '/css/custom_er.css');
	wp_enqueue_script('custom_js', get_template_directory_uri() . '/js/custom_er.js', NULL, 1.0, true);
	wp_localize_script('custom_js', 'customData', array(
...
add_action('wp_enqueue_scripts', 'primer_resources');